...
**当前版本：v1.7.17**  
**阶段：自动写作闭环收束版 — AI 生成→检查→修稿→复检→上下文追踪**

v1.7.17 完成版本统一、AI 修稿 SQLite 持久化、回退/采用 UI、上下文接入修稿、上下文读取日志持久化。

v1.7.13～v1.7.16 已完成：章节上下文、卷上下文、上下文读取策略、质量检查闭环、AI 自动修稿原型。
...
| v1.7.12 | 已完成：AI任务删除修复 + 质量检查问题处理闭环 |
| v1.7.13 | 已完成：章节总结→章节上下文升级 |
| v1.7.14 | 已完成：卷上下文自动汇总 |
| v1.7.15 | 已完成：统一上下文读取策略 |
| v1.7.16 | 已完成：质量检查定位修复 + AI自动修稿 |
| v1.7.17 | 当前：自动写作闭环收束版 |
| v1.8.0 | 计划：分卷大纲生成 |
| v1.9.0 | 计划：章节大纲生成 |
