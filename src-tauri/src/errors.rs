...
pub mod codes {
    ...
    pub const AI_WORKER_PROVIDER_UNAVAILABLE: &str = "AI_WORKER_PROVIDER_UNAVAILABLE";
    pub const AI_WORKER_LEASE_LOST: &str = "AI_WORKER_LEASE_LOST";
    pub const AI_WORKER_INTERRUPTED: &str = "AI_WORKER_INTERRUPTED";
    pub const AI_WORKFLOW_CYCLE: &str = "AI_WORKFLOW_CYCLE";
    pub const AI_WORKFLOW_SCOPE_MISMATCH: &str = "AI_WORKFLOW_SCOPE_MISMATCH";
    pub const AI_WORKFLOW_DEPENDENCY_BLOCKED: &str = "AI_WORKFLOW_DEPENDENCY_BLOCKED";
    pub const AI_WORKFLOW_STALE: &str = "AI_WORKFLOW_STALE";
    ...
    pub const PLACEMENT_PROPOSAL_NOT_FOUND: &str = "PLACEMENT_PROPOSAL_NOT_FOUND";
    pub const PLACEMENT_PROPOSAL_STALE: &str = "PLACEMENT_PROPOSAL_STALE";
    pub const PLACEMENT_TARGET_UNRESOLVED: &str = "PLACEMENT_TARGET_UNRESOLVED";
    pub const APPLY_PLAN_NOT_FOUND: &str = "APPLY_PLAN_NOT_FOUND";
    pub const APPLY_PLAN_ILLEGAL_TRANSITION: &str = "APPLY_PLAN_ILLEGAL_TRANSITION";
    pub const APPLY_PLAN_STALE: &str = "APPLY_PLAN_STALE";
    pub const TARGET_NOT_FOUND: &str = "TARGET_NOT_FOUND";
    pub const TARGET_SCOPE_MISMATCH: &str = "TARGET_SCOPE_MISMATCH";
    pub const TARGET_VERSION_CONFLICT: &str = "TARGET_VERSION_CONFLICT";
    pub const TARGET_HASH_CONFLICT: &str = "TARGET_HASH_CONFLICT";
