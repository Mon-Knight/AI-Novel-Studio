...
fn main() {
    ...
    tauri::Builder::default()
        .invoke_handler(generate_app_handler![
            ...
            commands::memory::get_memory_snapshot,
            commands::memory::list_memory_snapshots_by_chapter,
            commands::memory::verify_memory_snapshot,
            ...
            commands::autonomous::create_autonomous_job,
            commands::autonomous::get_autonomous_job,
            commands::autonomous::list_autonomous_jobs_by_novel,
            commands::autonomous::update_autonomous_job_status,
            commands::autonomous::update_autonomous_job_progress,
            commands::autonomous::pause_autonomous_job,
            commands::autonomous::resume_autonomous_job,
            commands::autonomous::cancel_autonomous_job,
            commands::autonomous::get_quality_thresholds,
            commands::autonomous::save_quality_thresholds,
            commands::autonomous::log_autonomous_action,
            commands::autonomous::list_autonomous_actions,
            commands::autonomous::create_continuity_check,
            commands::autonomous::create_expert_collaboration_log,
            commands::autonomous::acquire_chapter_lock,
            commands::autonomous::release_chapter_lock,
            commands::autonomous::adopt_autonomous_chapter_draft,
            commands::autonomous::cleanup_expired_locks,
