...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::co_creation::open_co_creation_workspace,
            commands::co_creation::read_co_creation_workspace,
            commands::co_creation::recover_co_creation_turn_task,
            commands::co_creation::append_co_creation_user_message,
            commands::co_creation::bind_co_creation_turn_task,
            commands::co_creation::complete_co_creation_turn,
            commands::co_creation::fail_co_creation_turn,
            commands::co_creation::save_co_creation_draft_revision,
