...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(generate_app_handler![
            ...
            commands::list_chapter_events,
            commands::create_chapter_event,
            commands::update_chapter_event,
            commands::set_chapter_event_status,
            commands::delete_chapter_event,
            ...
            services::dsh::commands::dsh_start_task_turn,
            services::dsh::commands::dsh_cancel_task_run,
            services::dsh::commands::dsh_get_task_runtime_status,
            services::dsh::commands::dsh_list_task_runtime_status,
            services::dsh::commands::dsh_describe_runtime,
