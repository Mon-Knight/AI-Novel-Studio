...
| 文档 | 说明 | 状态 |
|------|------|------|
| [version-roadmap.md](version-roadmap.md) | 当前权威版本路线图 | ✅ v2.12.0 已同步 |
...
| [release-history.md](project/release-history.md) | 发布历史汇总 | 🚧 占位，待后续细化 |
...
| [testing.md](technical/testing.md) | 测试策略与用例 | ✅ v2.12.0 已补充 |
...
| [chapter-continuity-memory.md](architecture/chapter-continuity-memory.md) | v2.6.0 不可变 Memory Snapshot、确定性预算与来源漂移复验 | ✅ 已实现 |
...
| [v2.6.0 Memory Facts 验收报告](audit/phase-3/13-v2.6.0-memory-facts-acceptance.md) | Memory 时间边界、预算、不可变、漂移与桌面 E2E 证据 | ✅ 已记录 |
...
| [release-notes-v2.4.0.md](release-notes-v2.4.0.md) | v2.4.0 Context / Constraint Compiler 与 Tool Registry 发布说明 |
| [release-notes-v2.5.0.md](release-notes-v2.5.0.md) | v2.5.0 Chapter Readiness Planner Runtime 发布说明 |
| [release-notes-v2.6.0.md](release-notes-v2.6.0.md) | v2.6.0 Chapter Continuity Memory Facts 发布说明 |
| [release-notes-v2.12.0.md](release-notes-v2.12.0.md) | v2.12.0 Autonomous Generation Phase 0-5 发布说明 |
| [ai-provider-integration-plan.md](ai-provider-integration-plan.md) | Autonomous Provider 执行契约与验证 |
| [end-to-end-testing-plan.md](end-to-end-testing-plan.md) | Autonomous 桌面 E2E 验收路径 |
| [ui-control-panel-plan.md](ui-control-panel-plan.md) | Autonomous 控制面板交互范围 |
