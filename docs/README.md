...
| 文档 | 说明 | 状态 |
|------|------|------|
| [version-roadmap.md](version-roadmap.md) | 当前权威版本路线图 | ✅ v2.1.5 已同步 |
...
| [testing.md](technical/testing.md) | 测试策略与用例 | ✅ v2.1.5 已补充 |
| [desktop-e2e.md](technical/desktop-e2e.md) | Windows 真实 Tauri E2E、隔离与排障 | ✅ v2.1.5 已补充 |
