...
export const mockChapters: Chapter[] = [
  {
    ...
    wordCount: 1542,
    outline: '林远在陌生的房间里醒来，记忆出现断层。适应指导员艾琳出现并开始引导他了解第七前哨站。',
    goal: '建立陌生感和悬念，引入适应指导员艾琳，埋下传送系统秘密的伏笔',
    drafts: [],
  ...
  },
  {
    ...
    targetWordCount: 4000,
    wordCount: 2100,
    outline: '林远开始深入了解第七前哨站的运作方式，发现了一些不寻常的细节。',
    goal: '展示前哨站日常、揭示第一个异常现象、加深读者对世界规则的认知',
    drafts: [],
...
export const mockVolumes = [
  {
    ...
    goal: '主角了解世界规则并第一次主动选择命运',
    mainConflict: '主角特殊能力与王国法则之间的冲突',
  ...
  },
  {
    ...
    orderIndex: 1,
    sortOrder: 1,
    summary: '林远抵达王城，卷入政治阴谋与星际风暴。各方势力开始注意到这个来自母星的不速之客。',
