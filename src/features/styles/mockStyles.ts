...
export const mockCharacters: Character[] = [
  {
    id: 'char-001', novelId: 'novel-001', name: '林远', roleType: 'protagonist',
    identity: '航天工程师', faction: '第七前哨站',
    relationToProtagonist: '本人', goal: '找到回家的方法，同时揭开第七前哨站背后的真相',
    personality: '理性冷静，善于观察和分析，但在情感表达上较为内敛',
    behaviorLimits: '不能杀人（除非自卫）', forbiddenBehaviors: '不能背叛朋友',
  ...
  {
    id: 'char-002', novelId: 'novel-001', name: '艾琳(E-247)', roleType: 'supporting',
    identity: '适应指导员', faction: '第七前哨站',
    relationToProtagonist: '指导员', goal: '完成指导员职责，但内心对系统的某些做法存有疑虑',
    personality: '训练有素，情绪控制力强，在执行职责和个人良知之间存在冲突',
    behaviorLimits: '', forbiddenBehaviors: '不能违反前哨站指令',
    currentState: '正在引导林远适应前哨站生活',
    source: 'manual', isActive: true,
    createdAt: '2026-05-10T09:00:00Z', updatedAt: '2026-05-10T09:00:00Z',
  },
  {
    id: 'char-003', novelId: 'novel-001', name: '卡尔·雷恩', roleType: 'antagonist',
    identity: '安全主管', faction: '第七前哨站',
    relationToProtagonist: '潜在对手', goal: '维护前哨站的安全和传送系统的秘密',
    personality: '表面和善，实际上为了维护系统稳定可以牺牲任何人',
    behaviorLimits: '', forbiddenBehaviors: '不能公开违反联盟条例',
