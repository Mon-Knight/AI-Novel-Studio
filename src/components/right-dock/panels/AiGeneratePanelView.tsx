import type { AiSettings, ChapterGenerationContext, ChapterPromptDebugInfo, OutlineKeyPoint } from '../../../types/ai';
...
export function AiGeneratePanelView({
  novelId, chapter, settings, contextCount, contextLoadError, wordCountDraft,
  wordCountSaving, wordCountSaved, genMode, availableStyles, selectedStyleId,
  availableOutputs, selectedOutputId, userInstruction, contextSummary,
  promptDebug, showContext, generating, revising, streamPreview,
  streamPreviewStatus, statusMsg, errorMsg, validationState,
  latestGeneratedDraft, latestGeneratedTarget, latestGeneratedAlreadyDisplayed,
  candidateApplyAvailable, adopting, onWordCountChange, onWordCountSave, onModeChange, onStyleChange,
  onOutputChange, onInstructionChange, onPreviewContext, onGenerate,
  onReviseByOutline, onKeepDraft, onAppendCandidate, onReplaceCandidate,
  onAdopt,
        ...
        <div className="panel-field" style={{ marginTop: 8 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <input
              ...
              onBlur={() => { if (wordCountDraft <= 0) onWordCountChange(4000); }}
              min={500}
              max={50000}
              step={100}
