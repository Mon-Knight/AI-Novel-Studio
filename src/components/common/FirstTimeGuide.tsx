  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 13, color: 'var(--color-text-secondary)', lineHeight: 2 }}>
        <div>
          1. 📖 <strong>创建作品</strong> — 填写作品名称、题材和简介
        </div>
        <div>
          2. 🌍 <strong>填写世界背景</strong> — 输入大致世界观和规则体系
        </div>
        <div>
          3. 👤 <strong>设定主角</strong> — 定义主角性格、能力和限制
        </div>
        <div>
          4. 📚 <strong>创建分卷与章节</strong> — 规划长篇结构
        </div>
        <div>
          5. 👥 <strong>添加角色</strong> — 建立角色库，选择本章出场角色
        </div>
        <div>
        ...
        <div>
          9. 📝 <strong>生成章节总结</strong> — 沉淀上下文供后续章节使用
        </div>
        <div>
          10. 📦 <strong>导出作品</strong> — 在作品详情页导出 TXT / Markdown
        </div>
      </div>
    </div>
  );
