export const APP_ERROR_CODES = [
  ...
  'AGENT_PLAN_INPUT_INVALID',
  'AGENT_PLAN_ILLEGAL_TRANSITION',
  'AGENT_PLAN_STEP_NOT_READY',
  'AGENT_PLAN_LEASE_REQUIRED',
  ...
  'AUTONOMOUS_JOB_ILLEGAL_TRANSITION',
  'AUTONOMOUS_JOB_ALREADY_ACTIVE',
  'AUTONOMOUS_JOB_PROGRESS_CONFLICT',
  'AUTONOMOUS_LOCK_NOT_OWNED',
  'AUTONOMOUS_ADOPTION_CONFLICT',
...
const USER_MESSAGES: Partial<Record<AppErrorCode, string>> = {
  ...
  AGENT_PLAN_NOT_FOUND: '章节准备计划不存在。',
  AGENT_PLAN_INPUT_INVALID: '章节准备计划契约无效。',
  AGENT_PLAN_ILLEGAL_TRANSITION: '章节准备计划当前状态不允许该操作。',
  AGENT_PLAN_STEP_NOT_READY: '计划步骤的依赖尚未完成。',
  AGENT_PLAN_LEASE_REQUIRED: '计划执行租约不存在。',
  ...
  MEMORY_SNAPSHOT_NOT_FOUND: '未找到长期记忆快照。',
  MEMORY_INPUT_INVALID: '记忆快照请求无效。',
  MEMORY_SOURCE_INVALID: '记忆来源包含不安全内容，已阻止持久化。',
  MEMORY_BUDGET_EXCEEDED: '记忆快照超过本地预算。',
  MEMORY_SOURCE_DRIFT: '记忆来源已变化，请创建新快照。',
  AUTONOMOUS_JOB_NOT_FOUND: '自主生成任务不存在。',
  AUTONOMOUS_JOB_ILLEGAL_TRANSITION: '自主生成任务当前状态不允许该操作。',
  AUTONOMOUS_JOB_ALREADY_ACTIVE: '该作品已有活动的自主生成任务。',
  AUTONOMOUS_JOB_PROGRESS_CONFLICT: '自主生成进度已变化，迟到结果未写入。',
  AUTONOMOUS_LOCK_NOT_OWNED: '章节生成锁已失效，迟到结果未采用。',
  AUTONOMOUS_ADOPTION_CONFLICT: '自主采纳前置条件已变化，候选草稿未采用。',
